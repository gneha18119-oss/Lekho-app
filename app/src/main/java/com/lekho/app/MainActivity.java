        ...
        public void sendOtp(String phoneNumber) {
            runOnUiThread(() -> {
                ...
                try {
                    PhoneAuthOptions options = PhoneAuthOptions.newBuilder(firebaseAuth)
                            ...
                            .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                                ...
                                @Override public void onVerificationFailed(@NonNull FirebaseException e) {
                                    sendOtpError("OTP भेजा नहीं जा सका: " + (e.getMessage() == null ? "कृपया Firebase Phone Auth settings जांचें।" : e.getMessage()));
                                }
                    ...
                    sendOtpError("OTP शुरू नहीं हो पाया: " + (e.getMessage() == null ? "फिर कोशिश करें।" : e.getMessage()));
                }
            });
        }
        ...
        public void verifyOtp(String verificationId, String code) {
            runOnUiThread(() -> {
                try {
                    ...
                    sendOtpError("OTP verify नहीं हो पाया। सही 6 digit OTP डालें।");
                }
            });
        }

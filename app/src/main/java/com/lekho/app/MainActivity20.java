...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        if (webView != null) {
            webView.evaluateJavascript("(function(){var m=document.querySelector('.productModal');if(m){m.remove();return 'modal';}var p=document.querySelector('.nav button.active');var page=p?p.getAttribute('data-page'):'';if(page&&page!=='home'){var hb=document.querySelector('[data-page=home]');if(hb)hb.click();return 'page';}return 'exit';})()", value -> {

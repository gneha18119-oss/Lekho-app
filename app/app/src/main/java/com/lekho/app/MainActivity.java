...
public class MainActivity extends Activity {
    ...
    public class FirebaseBridge {
        ...
        public void sendOtp(
            ...
            if (phone == null
                ...
                runJs(
                        callback +
                        "(false,'सही 10 अंकों का मोबाइल नंबर डालें।','')"
                );
    ...
    public void onRequestPermissionsResult(
        ...
        if (requestCode == MIC_REQUEST
            ...
            Toast.makeText(
                    this,
                    "लेखो ऐप को Microphone permission दें।",
                    Toast.LENGTH_LONG
            ).show();
        }
    }
